...
const UNIT_CROSS: [Pt; 12] = [
    (0.34, 0.0), (0.66, 0.0), (0.66, 0.34), (1.0, 0.34),
    (1.0, 0.66), (0.66, 0.66), (0.66, 1.0), (0.34, 1.0),
    (0.34, 0.66), (0.0, 0.66), (0.0, 0.34), (0.34, 0.34),
];

const UNIT_L: [Pt; 6] = [
    (0.0, 0.0), (0.36, 0.0), (0.36, 0.64), (1.0, 0.64), (1.0, 1.0), (0.0, 1.0),
];

const UNIT_CHEVRON: [Pt; 6] = [
    (0.0, 0.0), (0.45, 0.0), (1.0, 0.5), (0.45, 1.0), (0.0, 1.0), (0.55, 0.5),
];
...
const UNIT_ARROW_NE: [Pt; 7] = [
    (0.0, 0.86), (0.52, 0.34), (0.38, 0.20), (0.86, 0.14),
    (0.80, 0.62), (0.66, 0.48), (0.14, 1.0),
];

const UNIT_ARROW_LR: [Pt; 10] = [
    (0.0, 0.5), (0.25, 0.15), (0.25, 0.35), (0.75, 0.35), (0.75, 0.15),
    (1.0, 0.5), (0.75, 0.85), (0.75, 0.65), (0.25, 0.65), (0.25, 0.85),
];

const UNIT_ARROW_4: [Pt; 24] = [
    (0.5, 0.0), (0.72, 0.22), (0.6, 0.22), (0.6, 0.4),
    (0.78, 0.4), (0.78, 0.28), (1.0, 0.5), (0.78, 0.72),
    (0.78, 0.6), (0.6, 0.6), (0.6, 0.78), (0.72, 0.78),
    (0.5, 1.0), (0.28, 0.78), (0.4, 0.78), (0.4, 0.6),
    (0.22, 0.6), (0.22, 0.72), (0.0, 0.5), (0.22, 0.28),
    (0.22, 0.4), (0.4, 0.4), (0.4, 0.22), (0.28, 0.22),
];

const UNIT_SHIELD: [Pt; 10] = [
    (0.03, 0.05), (0.5, 0.0), (0.97, 0.05), (0.96, 0.40), (0.90, 0.66),
    (0.76, 0.86), (0.5, 1.0), (0.24, 0.86), (0.10, 0.66), (0.04, 0.40),
];

const UNIT_HOUSE: [Pt; 7] = [
    (0.5, 0.0), (1.0, 0.42), (0.84, 0.42), (0.84, 1.0), (0.16, 1.0), (0.16, 0.42), (0.0, 0.42),
];

const UNIT_BOOKMARK: [Pt; 5] = [
    (0.0, 0.0), (1.0, 0.0), (1.0, 1.0), (0.5, 0.74), (0.0, 1.0),
];

const UNIT_TAG: [Pt; 5] = [
    (0.0, 0.5), (0.28, 0.08), (1.0, 0.08), (1.0, 0.92), (0.28, 0.92),
];
...
const UNIT_ARROW_BENT: [Pt; 10] = [
    (0.0, 0.62), (0.0, 0.38), (0.58, 0.38), (0.58, 0.14), (1.0, 0.44),
    (0.58, 0.74), (0.58, 0.50), (0.22, 0.50), (0.22, 1.0), (0.0, 1.0),
];

const UNIT_ARROW_U: [Pt; 11] = [
    (0.06, 1.0), (0.06, 0.46), (0.30, 0.46), (0.30, 0.72), (0.62, 0.72),
    (0.62, 0.46), (0.44, 0.46), (0.72, 0.10), (1.0, 0.46), (0.82, 0.46), (0.82, 1.0),
];

const UNIT_ARROW_PENTA: [Pt; 5] = [
    (0.0, 0.16), (0.66, 0.16), (1.0, 0.5), (0.66, 0.84), (0.0, 0.84),
];

const UNIT_CALLOUT_SQ: [Pt; 7] = [
    (0.0, 0.0), (1.0, 0.0), (1.0, 0.70), (0.44, 0.70), (0.20, 1.0), (0.24, 0.70), (0.0, 0.70),
];

const UNIT_CROSS_THIN: [Pt; 12] = [
    (0.42, 0.0), (0.58, 0.0), (0.58, 0.42), (1.0, 0.42),
    (1.0, 0.58), (0.58, 0.58), (0.58, 1.0), (0.42, 1.0),
    (0.42, 0.58), (0.0, 0.58), (0.0, 0.42), (0.42, 0.42),
];
...
const UNIT_FRAME: [Pt; 8] = [
    (0.0, 0.0), (1.0, 0.0), (0.86, 0.16), (0.14, 0.16),
    (0.14, 0.84), (0.86, 0.84), (1.0, 1.0), (0.0, 1.0),
];

const UNIT_CHEVRON_THIN: [Pt; 6] = [
    (0.0, 0.0), (0.30, 0.0), (0.62, 0.5), (0.30, 1.0), (0.0, 1.0), (0.32, 0.5),
];

const UNIT_ZIGZAG: [Pt; 10] = [
    (0.0, 0.28), (0.25, 0.0), (0.50, 0.28), (0.75, 0.0), (1.0, 0.28),
    (1.0, 0.56), (0.75, 0.28), (0.50, 0.56), (0.25, 0.28), (0.0, 0.56),
];

const UNIT_CUBE: [Pt; 6] = [
    (0.0, 0.28), (0.30, 0.0), (1.0, 0.0), (1.0, 0.72), (0.70, 1.0), (0.0, 1.0),
];

const UNIT_PLAQUE: [Pt; 8] = [
    (0.14, 0.0), (0.86, 0.0), (1.0, 0.14), (1.0, 0.86),
    (0.86, 1.0), (0.14, 1.0), (0.0, 0.86), (0.0, 0.14),
];

const UNIT_BEVEL: [Pt; 8] = [
    (0.18, 0.0), (0.82, 0.0), (1.0, 0.18), (1.0, 0.82),
    (0.82, 1.0), (0.18, 1.0), (0.0, 0.82), (0.0, 0.18),
];

const UNIT_DIAMOND_LONG: [Pt; 6] = [
    (0.5, 0.0), (1.0, 0.30), (1.0, 0.70), (0.5, 1.0), (0.0, 0.70), (0.0, 0.30),
];
    ...
    (0..n * 2)
        .map(|i| {
            ...
            let a = -std::f32::consts::FRAC_PI_2
                + i as f32 / (n * 2) as f32 * std::f32::consts::TAU;
...
pub fn fill_polygon(c: &mut Canvas, pts: &[Pt], col: Color32) {
    ...
    let ymin = pts.iter().fold(f32::MAX, |m, p| m.min(p.1)).floor().max(0.0) as i32;
    let ymax = pts
        .iter()
...
mod tests {
    ...
    fn toda_forma_queda_dentro_de_su_caja() {
        for s in ALL_SHAPES {
            ...
            if s.is_closed() {
                assert!(pts.len() >= 3, "{:?} es cerrada pero tiene {} puntos", s, pts.len());
            }
        }
    }
